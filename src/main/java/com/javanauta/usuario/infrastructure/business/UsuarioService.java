...
import com.javanauta.usuario.infrastructure.business.converter.UsuarioConverter;
...
public class UsuarioService {
    ...
    public UsuarioDTO atualizaDadosUsuario(String token, UsuarioDTO dto) {
        // Aqui buscamos o email do usuário através do token (tirar obrigatoriedade de passar o email)
    ...
    public EnderecoDTO cadastraEndereco(String token, EnderecoDTO dto) {
        ...
        Usuario usuario = usuarioRepository.findByEmail(email).orElseThrow(() ->
                new ResourceNotFoundException("Id não encontrado " + email));
